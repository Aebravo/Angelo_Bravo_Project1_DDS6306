...
#Read supplied data
cdw = getwd()
brewwriesData = read.csv("C:\\Users\\Abrave\\OneDrive - Sempra Energy\\User Folders\\Downloads\\MDS-6306-Doing-Data-Science-Fall-2019-master (1)\\MDS-6306-Doing-Data-Science-Fall-2019-master\\Unit 8 and 9 Case Study 1\\Breweries.csv", header = TRUE)
beerData = read.csv("C:\\Users\\Abrave\\OneDrive - Sempra Energy\\User Folders\\Downloads\\MDS-6306-Doing-Data-Science-Fall-2019-master (1)\\MDS-6306-Doing-Data-Science-Fall-2019-master\\Unit 8 and 9 Case Study 1\\Beers.csv",header = TRUE)
#Analyse the data
gg_miss_var(brewwriesData)
gg_miss_var(beerData)
# about 58.3% of data are not missing any values
# 40% of IBU and 2.6% of ABV are misisng values
#miceBeer = beerData(-c('Name', 'Beer_ID))
...
#beerData %>% ggplot(aes(x = IBU, y = ABV)) + geom_point()
...
#Lis tthe variables we want to be used for the calculations
...
predictorMatrix
#.libPaths()
#mp <- mice(t, print = FALSE, predictorMatrix = predictorMatrix)
#mp$predictorMatrix
...
#summary(imputedBeer)
#imputedBeer$imp$IBU
#densityplot(imputedBeer,IBU ~ ABV)
```
...
#beerBrewries %>% ggplot(aes(y = Style, x = ABV)) + geom_point()
#unique(beerBrewries$Style)
###7 relation between ABV and IBU
#Before
#beerData %>% ggplot(aes(x = IBU, y = ABV)) + geom_point() + labs(title="Relation of ABV vs IBU before including missing data", y = "ABV", x="IBU" ) 
